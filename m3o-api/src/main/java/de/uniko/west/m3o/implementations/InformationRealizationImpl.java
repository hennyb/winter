...
public class InformationRealizationImpl implements InformationRealization {

	Winter winter = null;
	
	@winter_id("m3o:InformationRealization")
	URI objectID = null;
	
	public InformationRealizationImpl(){
		try {
			objectID = new URI("http://m3o:InformationRealization#" + UUID.randomUUID().toString());
