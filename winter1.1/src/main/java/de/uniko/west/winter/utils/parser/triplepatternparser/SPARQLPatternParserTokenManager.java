...
/* Generated By:JJTree&JavaCC: Do not edit this line. SPARQLPatternParserTokenManager.java */
...
/** Token Manager. */
public class SPARQLPatternParserTokenManager implements SPARQLPatternParserConstants
{
...
/** Constructor. */
public SPARQLPatternParserTokenManager(JavaCharStream stream){
...
/** Constructor. */
public SPARQLPatternParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
