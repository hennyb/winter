 ...
 *
 */
public class DeleteDataQueryTask extends DefaultQueryTask {
	public DeleteDataQueryTask(InfoNode node, URI graph, Map<String, URI> prefixMap, QueryTaskExecutor executor, String ... var) {
